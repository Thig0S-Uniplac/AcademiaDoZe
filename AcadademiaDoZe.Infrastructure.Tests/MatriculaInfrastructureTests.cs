...
public class MatriculaInfrastructureTests : TestBase
{
    ...
    public async Task Matricula_Atualizar_Sucesso()
    {
        ...
        Assert.Equal("Thiago kovalski", noBanco.Objetivo);
        Assert.Equal("Sqlite gente boa", noBanco.ObservacoesRestricoes);
